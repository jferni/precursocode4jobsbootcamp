...
if (personas[nombre]) {
    ...
    document.querySelector("#title").innerHTML = personas[nombre].name;

    document.querySelector("body").style.background = personas[nombre].eyeColor;

    document.querySelector("#age").innerHTML = "Age: " + personas[nombre].age;
    document.querySelector("#email").innerHTML = "Email: " + personas[nombre].email;
    document.querySelector("#address").innerHTML = "Address: " + personas[nombre].address;
}
else {

    window.alert("Nombre no existente");
